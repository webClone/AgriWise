"""
⚠️ DEPRECATED — Legacy Orchestrator V1 (moved here Phase 3 Quarantine, 2026-03-25)
   Use orchestrator_v2/run_entrypoint.py for all production traffic.
   This file is retained for reference only. Do NOT import from this module.

Original: AgriBrain Orchestrator.
...
class AgriBrainOrchestrator:
    ...
    def run_analysis(self, plot_id: str, config: Dict[str, Any] = None, user_query: str = None, injected_context: Dict[str, Any] = None):
        ...
        try:
            # NOTE: action_ranker.rank_actions now expects Layer8Input, not raw dicts.
            # This legacy codepath uses the inline fallback below.
            # Full Layer8Input construction is in orchestrator_v2/runner.py.
            scenarios = [
